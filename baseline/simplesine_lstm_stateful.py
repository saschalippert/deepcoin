...
def test_model(model, data, seq_length):
    ...
    gen_seq_torch = torch.tensor(data[0:seq_length], dtype=torch.float32)
    ...
    for i in range(1, predict_len):
        ...
        out = out.reshape((1, 1, 1)).to(device)
...
writer = SummaryWriter(log_dir="/home/sascha/logs/simplesine13")
